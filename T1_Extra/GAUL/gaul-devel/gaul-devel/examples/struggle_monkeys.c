 ...
 **********************************************************************
  ...
  struggle_monkeys - Test/example program for GAUL.
 ...
 **********************************************************************
  ...
  Synopsis:	Test/example program for GAUL.
		...
		This program trys to perform the same optimisation as
		struggle.c, expect by using the "Monkeys at keyboards"
		algorithm. ;-)
